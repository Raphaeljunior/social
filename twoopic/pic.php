...
<?php 
include('allcon.php');
echo '<div data-role="header" style="background:#3b5998">
<h1>Set Profile Pic</h1>
</div>';
...
<form action="pic.php"  method="post" enctype="multipart/form-data" data-ajax="false">

<input type="file" name="file" id="file">

<input id="upload" type="submit" name="submit" value="Upload" data-theme="c" data-mini="true" data-inline="true">
</form>
<br><a href="mhome.php" rel="external">Skip This Step</a>
</div</ul>';
if($show==success){
echo '<ul  class="bg-cyan fg-white">
<div align="center">
...
<form method="post" action="editpic.php?mobile=x" data-ajax="false">
