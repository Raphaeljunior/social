...
<?php 
include('allcon.php');
echo '<h4>Choose a new cover photo '.$_GET[user].' for your profile</h4>';
...
<form action="appcover.php?user='.$_GET[user].'"  method="post" enctype="multipart/form-data" data-ajax="false">
...
<img style="width:300px;height:300px;border:solid 0.5px;border-radius:10px" src="profilepics/'.$nam.'"><br>

<form method="post" action="editcover.php?user='.$_GET[user].'" data-ajax="false">
<div style="display:none">
<input type="text" name="name" id="name" value="'.$nam.'">

</div>
<input type="submit" name="submit" value="Set As Cover Photo" data-theme="c" data-mini="true" data-inline="true">
</form>
