...
<?php 
include('allcon.php');
echo '<h4>Choose a new cover photo '.$_SESSION['current'].' for your profile</h4>';
...
<form action="editcoverphoto.php"  method="post" enctype="multipart/form-data" data-ajax="false">
...
<form method="post" action="editcover.php" data-ajax="false">
