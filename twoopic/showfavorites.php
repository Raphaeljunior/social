...
$isfo="select * from favorites where itemid='$id' order by rand()";
$checkfollo=mysqli_query($con,$isfo);
$numfollow=mysqli_num_rows($checkfollo);

echo '<span style="color:#3b5998;font-size:15px"><b>'.$numfollow.' people favorited this post</b></span><br><br>';
