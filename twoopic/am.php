...
</td><td style="width:200px">'.$result[FirstName].' '.$result[SecondName].'<br><a href="http://localhost/twoopic/profile.php?user='.$result[Username].'" rel="external">
'.$result[Username].'</a>
