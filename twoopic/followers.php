...
url:"profilefeed.php?pfollowers=x",
type:"POST",
data:datastringa,
...
<li><a href="#" data-theme="c" style="width:100%;height:auto;border-bottom:solid 2px;border-bottom-color:dark" data-role="button">People following <?php echo $_GET[user] ?></a></li>
</div>			
